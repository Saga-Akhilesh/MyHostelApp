...
public class CouncilFHosMainSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass groundSecy=new CouncilUserClass("Nagarjuna","Ground Floor Hostel Secretary","1234567891","Nagarjuna@gmail.com",R.drawable.nagarjuna);
        CouncilUserClass firstSecy=new CouncilUserClass("Venkatesh","First Floor Hostel Secretary","1234567891","Venkatesh@gmail.com",R.drawable.venkatesh);
