...
public class CouncilWarden extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass MH1=new CouncilUserClass("Ranjinikanth","MH1 Hostel Warden","1234567891","Ranjinikanth@gmail.com",R.drawable.ranjinikanth);
        CouncilUserClass MH2=new CouncilUserClass("Yogi-Babu","MH2 Hostel Warden","1234567891","YogiBabu@gmail.com",R.drawable.yogibabu);
        CouncilUserClass MH3=new CouncilUserClass("Munishkanth","MH3 Hostel Warden","1234567891","Munishkanth@gmail.com",R.drawable.munishkanth);
        CouncilUserClass MH4=new CouncilUserClass("Mahesh","MH4 Hostel Warden","1234567891","Mahesh@gmail.com",R.drawable.mahesh);
